...
use \PowerComponents\LivewirePowerGrid\Themes\ {
    Theme,
    ThemeBase
};
...
class VeplexGrid extends ThemeBase
{
    ...
    {
        return Theme::table('min-w-full divide-y divide-gray-300 border-b dark:bg-gray-600 border-gray-400 table-auto')
            ...
            ->th('px-2 pr-4 py-3 text-left font-medium table-thead-veplex tracking-wider whitespace-nowrap dark:text-gray-300')
            ->tbody('text-gray-800')
            ->trBody('border border-gray-200 dark:border-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 table-view-blur')
